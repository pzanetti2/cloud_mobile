...
##### FROM FILES
tedx_dataset_path = "s3://tedx-2026-data-pz/final_list.csv"
...
## READ THE DETAILS
details_dataset_path = "s3://tedx-2026-data-pz/details.csv"
...
## READ TAGS DATASET
tags_dataset_path = "s3://tedx-2026-data-pz/tags.csv"
